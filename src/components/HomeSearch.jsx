    ...
    return (
        <>
            ...
            <div className='flex flex-col space-y-2 sm:space-y-0 justify-center sm:flex-row mt-8 sm:space-x-4'>
                ...
                <button onClick={randomSearch} disabled={randomSearchLoading} className='bg-[#f8f9fa] rounded-md text-sm text-gray-800 hover:ring-gray-200 focus:outline-none active:ring-gray-300 hover:shadow-md w-36 h-10 transition-shadow disabled:opacity-80 disabled:shadow-sm'>{randomSearchLoading ? "Loading..." : "I'm Feeling Lucky"}</button>
            </div>
        </>
    );
};
